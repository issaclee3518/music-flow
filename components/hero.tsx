...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      <div className="animation-delay-8 animate-fade-in relative z-10 mt-20 flex flex-col items-center justify-center px-4 text-center md:mt-20">
        <div className="mb-6 mt-10 sm:justify-center md:mb-4 md:mt-20">
          <div className="relative flex items-center whitespace-nowrap rounded-full border bg-popover px-3 py-1 text-xs leading-6  text-primary/60 ">
            <LayoutGrid className="h-5 w-5 p-1" /> Introducing Dicons.
            <a
